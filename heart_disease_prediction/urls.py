...
urlpatterns = [
    ...
    url(r'^Find_Heart_Disease_Ratio/$', serviceprovider.Find_Heart_Disease_Ratio, name="Find_Heart_Disease_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^Find_Heart_Disease_Status_Details/$', serviceprovider.Find_Heart_Disease_Status_Details, name="Find_Heart_Disease_Status_Details"),
