...
--
-- Host: localhost
-- Generation Time: Oct 26, 2021 at 01:06 PM
...
--
CREATE DATABASE IF NOT EXISTS `heart_disease_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
--
-- Table structure for table `remote_user_detection_results_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_detection_results_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(300) NOT NULL,
  `ratio` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `remote_user_heart_disease_model` (
  ...
  `trestbps` varchar(300) NOT NULL,
  `chol` varchar(300) NOT NULL,
  `fbs` varchar(300) NOT NULL,
  `resecg` varchar(300) NOT NULL,
  `thalach` varchar(300) NOT NULL,
  `exang` varchar(300) NOT NULL,
  `oldpeak` varchar(300) NOT NULL,
  `slope` varchar(300) NOT NULL,
  `ca` varchar(300) NOT NULL,
...
--
-- Table structure for table `remote_user_heart_disease_prediction_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_heart_disease_prediction_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `age` varchar(300) NOT NULL,
  `sex` varchar(300) NOT NULL,
  `cp` varchar(300) NOT NULL,
